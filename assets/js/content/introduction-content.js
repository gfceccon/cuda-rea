...
<p class=\"introduction\">These functions are similar to <span class=\"code-blue\">malloc<\/span>(), <span class=\"code-blue\">free<\/span>() and <span class=\"code-blue\">memcpy<\/span>() from C/C++, but the ones from CUDA API handle data on the device memory and the parameters and return values may differ slightly, as explained on the code section of the website.<\/p>",
