...
<p class=\"introduction\">Used to declare device code (functions). It is called from host code and executed on the device.<\/p>",
...
<p class=\"introduction\">The triple angle brackets is used to make a call from host code to device code (also called a kernel launch) with <b>N<\/b> blocks and <b>M<\/b> threads per block.<\/p>",
...
<\/ul> \
<h2>Device Managing functions<\/h2> <br> \
<ul style=\".\"> \
